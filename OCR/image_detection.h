...
int detect_char (IplImage *img,int *line_numbers,int line_numbers_size,struct rect_char *chars,struct rect_char **ptr,int up,int low,int old_size_c, int cpt_bloc, int old_size_l);
